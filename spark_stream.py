...
def create_key_space(session):
    ...
    """)
    print('Key space created success')
...
def create_spark_connection():
    ...
    try:
        ...
        logging.error('Spark connection created succeed')
    except Exception as e:
...
def create_cassandra_connection():
    ...
    try:
        ...
        logging.error(f'Could not found cassandra connection due to: {e}')
        return None
...
def connect_to_kafka(spark_conn):
    ...
    try:
        ...
        logging.error(f'kafka dataframe could not be created with error: {e}')
